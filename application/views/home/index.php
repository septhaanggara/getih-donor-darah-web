...
<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel" style="padding-top: 50px;">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="assets/img/HomePage Getih.jpg" class="d-block w-100" alt="slide1" width="450" height="550">
    </div>
    <div class="carousel-item">
      <img src="assets/img/HomePage Getih2.jpg" class="d-block w-100" alt="slide2" width="450" height="550">
    </div>
    <div class="carousel-item">
      <img src="assets/img/HomePage Getih3.jpg" class="d-block w-100" alt="slide3" width="450" height="550">
      </div>
    </div>
  </div>
